        ...
        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
          <div class="ml-6 relative">
            ...
            <div id="profile-dropdown" class="absolute right-0 top-full mt-1 w-56 bg-white text-gray-800 border border-gray-300 rounded-md shadow-lg opacity-0 invisible transition-opacity duration-200 z-50">
              ...
              <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                <a href="/sikenotarisan/admin/index.php" class="block px-4 py-2 hover:bg-indigo-100 hover:text-indigo-700">
                  <div class="flex items-center space-x-2">
              ...
              <?php endif; ?>
              <a href="/sikenotarisan/logout.php" class="block px-4 py-2 hover:bg-indigo-100 hover:text-indigo-700">Logout</a>
            </div>
          </div>
        <?php endif; ?>
      </div>
